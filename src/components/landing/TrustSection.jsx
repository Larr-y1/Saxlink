...
export default function TrustSection() {
  return (
    <section className="py-20 md:py-32 bg-[#faf9ff] dark:bg-secondary text-secondary-foreground relative overflow-hidden transition-colors duration-1000">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-20 md:mb-32">
          ...
          >
            ...
            <h2 className="font-heading text-4xl md:text-8xl lg:text-9xl font-black text-black dark:text-white leading-[0.8] tracking-tighter mb-12 transition-colors">
              Built on Trust & <br />
              <span className="italic font-light text-primary/80">Transparency.</span>
            </h2>
            
            <p className="text-xl md:text-2xl text-black dark:text-white/80 font-medium md:font-light leading-relaxed max-w-3xl mx-auto italic transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12 mb-32">
          {trusts.map((t, i) => (
            ...
            >
              <div className="relative bg-white dark:bg-white/[0.02] border border-primary/10 dark:border-white/10 rounded-[2.5rem] p-8 md:p-12 overflow-hidden hover:border-primary/40 transition-all duration-1000 premium-shadow h-full flex flex-col">
                
                {/* Floating Illustration Background */}
                <div className="absolute top-0 right-0 w-48 h-48 -translate-y-8 translate-x-8 opacity-[0.08] group-hover:opacity-100 group-hover:scale-110 transition-all [transition-duration:2s] ease-out">
                  {t.illustration}
                </div>

                <div className="relative z-10 flex flex-col h-full">
                  <div className="w-16 h-16 md:w-20 md:h-20 rounded-[1.5rem] md:rounded-[2rem] bg-secondary/10 dark:bg-white/5 border border-primary/20 dark:border-white/10 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-white group-hover:border-primary transition-all duration-700 shadow-2xl mb-10">
                    {t.icon}
                  </div>
                  <div>
        ...
        <div className="pt-24 border-t border-primary/20 dark:border-white/10 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-x-16 gap-y-12 opacity-80 grayscale-0 transition-all duration-1000">
            {partners.map((p) => (
